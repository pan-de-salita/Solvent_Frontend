...
import { faDna, faFlaskVial } from "@fortawesome/free-solid-svg-icons";
          ...
          <div className="rounded-lg mx-4 w-full max-w-5xl flex flex-col md:flex-row gap-4 shadow-sm">
            <div className="flex items-center p-4 rounded-l-lg bg-gradient-to-r from-[#1D1D1F] to-[#16171B] flex-grow">
              ...
              <div className="flex flex-col gap-1 text-sm">
                ...
                <span>Yeah, me neither. We definitely should though.</span>
                <div className="pt-4">
            ...
            <a href="https://www.codewars.com/post/8-reasons-why-codewarriors-practice-coding-with-codewars">
              <div
                role="button"
                className="h-full flex flex-col justify-start gap-2 px-4 py-5 rounded-lg bg-gray-400 w-full md:max-w-xs"
              >
                <span className="text-red-500 text-md">Read:</span>
                <span className="text-sm">
